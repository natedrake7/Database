...
sht:
	...
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/sht_main.c ./src/record.c ./src/sht_table.c ./src/ht_table.c ./src/hp_file.c -lbf -o ./build/sht_main -O2

stats:
	@echo " Compile stats_main ...";
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/stats_main.c ./src/record.c ./src/sht_table.c ./src/ht_table.c ./src/hash_statistics.c -lbf -o ./build/stats_main -O2
